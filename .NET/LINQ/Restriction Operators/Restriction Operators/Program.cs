...
namespace Restriction_Operators
{
    public class Program
    {
        ...
        public void WhereSimple1()
        {
            ...
            Console.WriteLine("Where - Simple 1 : This sample uses where to find all elements of an array less than 5.");
        ...
        public void WhereSimple2()
        {
            ...
            Console.WriteLine("Where - Simple 2 : This sample uses where to find all products that are out of stock.");
        ...
        public void WhereSimple3()
        {
            ...
            Console.WriteLine("Where - Simple 3 : This sample uses where to find all products that are in stock and cost more than 3.00 per unit.");
            foreach (var product in expensiveInStockProducts)
            {
                Console.WriteLine("{0} is in stock and costs more tha 3.00.", product.ProductName);
            }
        }
